<template>
  <div class="workflow-node prompt-enhancer-node" :class="{ processing: isProcessing }">
    ...
    <div class="node-header">
      ...
      <span class="node-title">{{ $t('workflow.imagePromptEnhancer') }}</span>
    ...
    <div class="node-body">
      <div class="form-row">
        ...
        <textarea 
          ...
          class="form-textarea"
          rows="3"
          :placeholder="$t('workflow.enterPromptToEnhance')"
        ></textarea>
      </div>
