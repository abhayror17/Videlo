  ...
  <div class="image-edit">
    ...
    <div class="prompt-area">
      <div class="prompt-wrapper">
        <textarea
          v-model="prompt"
          placeholder="Describe the transformation... e.g., 'Change background to sunset', 'Make it look like a painting'"
          rows="3"
          class="prompt-input"
      ...
      this.pollingId = setInterval(async () => {
        try {
          ...
          if (updated.status === 'completed') {
            ...
            this.stopPolling()
            this.generating = false
            alert('Edit failed: ' + (updated.error_message || 'Unknown error'))
          }
        } catch (error) {
